                ...
                <div className="form-blue">
                    <div className="form-line-blue">
                        <div className="form-group-blue">
                            <input type="text" className="form-control-blue" id="name" value={firstName} onChange={firstNameChange} placeholder="Rupesh" required autocomplete="off"/>
                            <label for="name" className="form-label-blue">First Name</label>
                        </div>
                        <div className="form-group-blue">
                            <input type="text" className="form-control-blue" id="lastName" value={lastName} onChange={lastNameChange} placeholder="Sinha" required autocomplete="off"/>
                    ...
                    <div className="form-line-blue">
                        <div className="form-group-blue">
                            <input type="email" className="form-control-blue" id="email" value={email} onChange={emailChange} placeholder="vatech@gmail" required autocomplete="off"/>
                            <label for="email" className="form-label-blue">Email</label>
                        </div>
                        <div className="form-group-blue">
                            <input type="number" className="form-control-blue" id="number" value={contact} onChange={contactChange} placeholder="+91987654321" required autocomplete="off"/>
                            <label for="number" className="form-label-blue">Contact Number</label>
                        </div>
                    </div>

                    <div className="form-group-blue message-blue">
                        <input type="text" className="form-control-blue" id="message" value={message} onChange={messageChange} placeholder="share your querry" required autocomplete="off"/>
                        <label for="message" className="form-label-blue">Message</label>
                    </div>

                    <input type="submit" onClick={()=>sendMessage()} value="Submit" className="submit-blue"/>
                </div>
            </div>
        </>
    );
